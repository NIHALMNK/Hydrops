...
export const homePageData: HomePageDocument = {
  ...
  journey: {
    ...
    stages: [
      ...
      { chapter: '02', title: 'Harvest.', description: 'Only the coconuts that have ripened completely are chosen. Not by machine — by hand, and by experience passed down through generations.', image: { src: '/images/journey/3-harvest.png', alt: 'Harvesting coconuts by hand', width: 960, height: 1200 }, mood: 'Patience is the first ingredient.' },
