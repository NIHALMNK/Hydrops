...
export function Navbar() {
  ...
  return (
    ...
    >
      <header 
        className={`relative flex h-[64px] w-full items-center justify-between rounded-full border px-8 py-2 shadow-lg backdrop-blur-[24px] transition-all duration-500 ease-out ${
          isLight 
