 ...
 */
interface Props { data: JourneyDocument; }

export function CoconutJourney({ data }: Props) {
  return (
    <div className="w-full">
      <section id="journey-section" className="relative w-full h-screen bg-[#0E1110] text-white overflow-hidden">
        ...
        <img
          src={data.ambientImage.src}
          alt={data.ambientImage.alt}
        ...
        <div className="journey-track flex h-full will-change-transform relative z-10" style={{ width: `${data.stages.length * 100}vw` }}>
