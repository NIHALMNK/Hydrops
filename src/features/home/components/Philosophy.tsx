...
/**
 * Philosophy – Section 03 of Hydrops homepage journey.
 * Features cream background, subtle HYDROPS watermark, top-right palm leaf line illustration,
 * bottom-left coconut cluster line illustration, and 3-chapter scroll-pinned GSAP sequence.
 */
export function Philosophy() {
  return (
    <div
      id="philosophy-section"
      className="bg-[#F5F2EC] text-[#1E1E1E] relative h-screen w-full overflow-hidden flex items-center justify-center select-none"
    >
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse at 50% 60%, rgba(200,169,106,0.06) 0%, transparent 70%)',
        }}
      />
      ...
      {/* ── Top-Right Palm Leaf Line Illustration ── */}
      {/* eslint-disable-next-line @next/next/no-img-element */}
      <img
        src="/assets/Gemini_Generated_Image_n90cohn90cohn90c.png"
        alt="Palm fronds line illustration"
        aria-hidden="true"
        className="absolute top-0 right-0 w-[170px] sm:w-[240px] md:w-[320px] lg:w-[380px] h-auto object-contain mix-blend-multiply opacity-80 z-0 pointer-events-none select-none translate-x-[8%] -translate-y-[8%]"
      />

      {/* ── Bottom-Left Coconut & Palm Leaves Line Illustration ── */}
      {/* eslint-disable-next-line @next/next/no-img-element */}
      <img
        src="/assets/Gemini_Generated_Image_6ra6rf6ra6rf6ra6.png"
        alt="Coconut cluster line illustration"
        aria-hidden="true"
        className="absolute bottom-0 left-0 w-[170px] sm:w-[240px] md:w-[320px] lg:w-[380px] h-auto object-contain mix-blend-multiply opacity-80 z-0 pointer-events-none select-none -translate-x-[8%] translate-y-[8%]"
      />
